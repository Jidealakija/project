...
<Link href='Signup'><p className='capitalize mt-10 font-medium text-3xl w-80 h-[45px] rounded-3xl m-auto justify-evenly bg-green-500 hover:bg-green-700'>get started</p></Link>
    </div>
  )
}
